<template>
  <div id="workflow-manager-container">
    <CreateConceptWorkflow v-if="selectedWorkflow.value == 'createWorkflow'" :selectedWorkflow="selectedWorkflow" :workflows="workflows" />
    <Panel
      v-if="selectedWorkflow.value == 'updateWorkflow'"
      header="Update Concept Workflow"
      :toggleable="true"
    >
      <DataTable
        :value="updateTable"
...
export default defineComponent({
  ...
  components: { CreateConceptWorkflow },
  data() {
    return {
      updateTable: [] as any,
      expandedRows: [],
  ...
  methods: {
    ...
    setContentHeight(): void {
      const container = document.getElementById("workflow-manager-container") as HTMLElement;
