<template>
  <Card class="header">
    ...
    <template #title>
      ...
      <span v-if="$route.name == 'Datamodel'">Data Models</span>
      <span v-if="$route.name == 'Ontology'">Semantic Ontology</span>
      <span v-if="$route.name == 'Valueset'">Value Sets</span>
    </template>
    <template #subtitle>
      <span v-if="$route.name == 'Home'"
        ...
        classes</span
      >
      <span v-if="$route.name == 'Datamodel'"
        ...
        created for a specific business of healthcare is separate to the
        ontology.</span
      >
      <span v-if="$route.name == 'Ontology'"
