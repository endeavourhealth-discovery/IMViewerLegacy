...
describe("Mappings.vue", () => {
  ...
  it("can get mappings ___ success", async() => {
    ...
    expect(wrapper.vm.simpleMaps).toStrictEqual([{"@id": "http://endhealth.info/emis#^ESCTAM784250", "name": "Amputation of right foot", "scheme": "EMIS (inc. Read2 like) namespace","code":"^ESCTAM784250"}, {"@id": "http://endhealth.info/emis#^ESCTAM784250", "name": "Amputation of right foot", "scheme": "EMIS (inc. Read2 like) namespace","code":"^ESCTAM784250"}]);
  });
