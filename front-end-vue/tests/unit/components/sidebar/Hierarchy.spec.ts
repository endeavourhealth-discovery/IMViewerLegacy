...
describe("Hierarchy.vue ___ DiscoveryOntology", () => {
  ...
  beforeEach(() => {
    jest.resetAllMocks();
    ConceptService.getConcept = jest.fn().mockResolvedValue({data:{
    ...
    ConceptService.getConceptParents = jest.fn().mockResolvedValue({data:[]});
    ConceptService.getConceptChildren = jest.fn().mockResolvedValue({data:[
  ...
  it("calls services, populates conceptAggregate and updatesHistory on mounted", async() => {
    expect(ConceptService.getConcept).toHaveBeenCalledTimes(1);
    expect(ConceptService.getConcept).toHaveBeenCalledWith("http://endhealth.info/im#DiscoveryOntology");
    expect(ConceptService.getConceptChildren).toHaveBeenCalledTimes(1);
    expect(ConceptService.getConceptChildren).toHaveBeenCalledWith("http://endhealth.info/im#DiscoveryOntology");
    expect(ConceptService.getConceptParents).toHaveBeenCalledTimes(1);
    expect(ConceptService.getConceptParents).toHaveBeenCalledWith("http://endhealth.info/im#DiscoveryOntology");
    await flushPromises();
...
describe("Hierarchy.vue ___ Concept", () => {
  ...
  it("calls services, populates conceptAggregate and updatesHistory on mounted", async() => {
    expect(ConceptService.getConcept).toHaveBeenCalledTimes(1);
    expect(ConceptService.getConcept).toHaveBeenCalledWith("http://snomed.info/sct#298382003");
    expect(ConceptService.getConceptChildren).toHaveBeenCalledTimes(1);
    expect(ConceptService.getConceptChildren).toHaveBeenCalledWith("http://snomed.info/sct#298382003");
    expect(ConceptService.getConceptParents).toHaveBeenCalledTimes(1);
    expect(ConceptService.getConceptParents).toHaveBeenCalledWith("http://snomed.info/sct#298382003");
    await flushPromises();
    expect(mockStore.commit).toHaveBeenCalledTimes(1);
    expect(mockStore.commit).toHaveBeenCalledWith("updateHistory", {
